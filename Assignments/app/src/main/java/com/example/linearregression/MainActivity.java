...
import com.example.linearregression.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pred.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prediction = (float) (Math.floor(prediction * 100) / 100);
                outp.setText(Float.toString(prediction) + " g");
            }
        });

    }
    private MappedByteBuffer loadModelFile() throws IOException {
        AssetFileDescriptor fileDescriptor=this.getAssets().openFd("bream.tflite");
